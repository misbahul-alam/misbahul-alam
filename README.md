...
I’m a **Backend Developer** focused on building scalable APIs, microservices, and reliable backend systems. I enjoy turning complex product requirements into clean, maintainable services using technologies like **Go, Node.js, and PostgreSQL**.

My work centers around backend architecture, database optimization, and event-driven systems. I aim to build backend foundations that remain stable, performant, and easy to maintain as applications grow.
